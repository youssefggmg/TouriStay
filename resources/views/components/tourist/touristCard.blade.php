<div class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300">
    ...
    <div class="p-4">
        <div class="flex justify-between items-start">
            <h3 class="text-lg font-semibold text-gray-900 mb-1">Luxury Beach Villa</h3>
        ...
        <p class="text-gray-600 mb-2">
            <i class="fas fa-map-marker-alt mr-1 text-gray-400"></i> Malibu, California
        </p>
        <div class="text-sm text-gray-500 mb-3">Available: May 15 - Jun 30</div>
        <div class="flex justify-between items-center">
            <div class="text-rose-600 font-semibold">$299 <span class="text-gray-500 font-normal">/ night</span></div>
        </div>
    </div>
</div>